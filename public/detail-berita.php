...
<body class="font-sans theme-custom bg-[#1E2F4D] text-white overflow-x-hidden" x-data="{ mobileMenuOpen: false }">
    ...
    <main x-data="{
        ...
        <div x-show="error" style="display: none;" class="max-w-3xl mx-auto px-4 text-center py-20">
            ...
            <h1 class="text-3xl font-bold text-white mb-4">Berita Tidak Ditemukan</h1>
            <p class="text-gray-300 mb-8">Maaf, berita yang Anda cari mungkin telah dihapus atau ID tidak valid.</p>
            <a href="berita.php"
        ...
        <article x-show="!loading && !error && berita" style="display: none;" class="max-w-4xl mx-auto px-4">
            ...
            <!-- Isi Konten Artikel -->
            <div class="news-content prose prose-lg prose-blue max-w-none text-gray-200 leading-relaxed bg-[#1E2F4D] p-8 md:p-12 rounded-3xl shadow-sm border border-white/20"
                x-html="berita?.isi">
            ...
            <div
                ...
                <div class="mb-4 md:mb-0">
                    <h4 class="font-bold text-white">Bagikan artikel ini:</h4>
                </div>
