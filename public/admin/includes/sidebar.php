...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
    ...
    <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto custom-scrollbar">
        ...
        <a href="dashboard.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'dashboard.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
        ...
        <a href="manage_news.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'manage_news.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
            <span class="text-sm">Kelola Berita</span>
        </a>

        <a href="manage_proker.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'manage_proker.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
            <span class="text-sm">Program Kerja</span>
        </a>

        <a href="manage_pengurus.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'manage_pengurus.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
            <span class="text-sm">Struktur Pengurus</span>
        </a>

        <a href="manage_banners.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'manage_banners.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
        ...
        <a href="manage_contacts.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'manage_contacts.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
            <span class="text-sm">Narahubung</span>
        </a>

        <a href="view_aspirasi.php" class="flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 <?= $current_page == 'view_aspirasi.php' ? 'bg-[#1E2F4D] text-white font-bold shadow-inner' : 'text-blue-100/70 hover:bg-[#1E2F4D]/40 hover:text-white' ?>">
